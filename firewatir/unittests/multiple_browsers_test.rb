...
class TC_MultipleBrowsers < Test::Unit::TestCase
    ...
    def test_commonwatir_multiple_browsers
      #
      # This test relies upon you having version 0.95 of the JSSH plugin installed.
      # This can be installed from the plugins folder in: http://github.com/ajcollins/JSSH-XPIs/tree/master
      # 
      ...
      # You will also need TCP port 9998 to be unused by anything else on your system.
      #
      options = { :browser => 'firefox', :multiple_browser_xpi => true, :port => 9998, :profile => 'port9998' }
      Watir.options = options
      browser2 = Watir::Browser.new()
      
      assert_equal(browser2.jssh.port, options[:port], "Firefox did not connect on port specified - Watir::Browser.new() did not supply options hash.") 
