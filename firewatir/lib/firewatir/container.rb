...
module FireWatir
  module Container 
    ...
    # Delegates execution of javascript to the JSSH Interface
    def execute(command)
      jssh.execute(command)
    end
    
    # Accessor for the jssh interface
    # used to send commands to Firefox
    def jssh
      @jssh ? @jssh : @container.jssh
    end
